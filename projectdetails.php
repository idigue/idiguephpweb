<?php
session_start();
require_once 'projects_service.php';
require_once 'projects_proposals_service.php';
$id = $_GET['id'];
if ($db instanceof mysqli) {
    ...
    // $project_array = fetchprojectbyid($db, $id);
    // $messages = fetchmessages($db, $id);
    // $proposals = fetchproposalsbyprojectid($db, $id);
    if ($_POST) {
